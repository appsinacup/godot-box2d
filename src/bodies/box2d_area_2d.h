#ifndef BOX2D_AREA_2D_H
#define BOX2D_AREA_2D_H
...
class Box2DArea2D : public Box2DCollisionObject2D {
	...
	SelfList<Box2DArea2D> monitor_query_list;
	SelfList<Box2DArea2D> area_override_update_list;
...
public:
	void on_body_enter(box2d::Handle p_collider_handle, Box2DBody2D *p_body, uint32_t p_body_shape, RID p_body_rid, ObjectID p_body_instance_id, box2d::Handle p_area_collider_handle, uint32_t p_area_shape);
	void on_body_exit(box2d::Handle p_collider_handle, Box2DBody2D *p_body, uint32_t p_body_shape, RID p_body_rid, ObjectID p_body_instance_id, box2d::Handle p_area_collider_handle, uint32_t p_area_shape, bool p_update_detection = true);

	void on_area_enter(box2d::Handle p_collider_handle, Box2DArea2D *p_other_area, uint32_t p_other_area_shape, RID p_other_area_rid, ObjectID p_other_area_instance_id, box2d::Handle p_area_collider_handle, uint32_t p_area_shape);
	void on_area_exit(box2d::Handle p_collider_handle, Box2DArea2D *p_other_area, uint32_t p_other_area_shape, RID p_other_area_rid, ObjectID p_other_area_instance_id, box2d::Handle p_area_collider_handle, uint32_t p_area_shape);
	...
	void set_space(Box2DSpace2D *p_space) override;
